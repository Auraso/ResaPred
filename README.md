...
- Please place these files in the corresponding folders (main/ResaPred, pdb, pssm, dssp), respectively, then follow the previous instructions to run the tool and predict protein flexibility.
